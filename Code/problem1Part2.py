"""
 EE232E Project 2 Problem 1 Part 2
 ...
 Reference:
  ...
  - http://www.imdb.com
 Description:
  - Prepare datasets for problem 4, 5, 6, 7
  - Remove all actors/actresses with less than 10
"""
...
print("Prepared the number of actors with great or equal to 10 movies is: %d" % count1)
print("Prepared the number of actresses with great or equal to 10 movies is: %d" % count2)
print("The total number of artists with great or equal to 10 movies is: %d" % (count1 + count2))
