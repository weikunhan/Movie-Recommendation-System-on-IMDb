"""
 ...
 Reference:
  ...
  - http://www.imdb.com
 Description:
  - Construct a weighted undirected graph for the movie network (problem 5 and 6)
"""
...
filename3 = open("./project_2_data/movie_graph.txt", "w")
...
print("Construct a weighted undirected graph for problem 5 and 6 successfully!")
print("The total number of edges in graph is: %d" % count)
print("The total number of nodes in graph is: %d" % count)
print("--------------------------------------------------------------------")
print()
